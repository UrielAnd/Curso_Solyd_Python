...
class Twitter:
    def __init__(self,consumer_key,consumer_secret,token_key,token_secret):
        self.conxao(self,consumer_key,consumer_secret,token_key,token_secret)

    def conxao(self,consumer_key,consumer_secret,token_key,token_secret):
        self.consumer = oauth2.Consumer(consumer_key, consumer_secret)
        self.token = oauth2.Token(token_key, token_secret)
        self.cliente = oauth2.Cliente(self.consumer, self.token)
        return self.cliente
